...
export default function CategoryForm(props) {
    ...
    const handleSubmit = (values) => {
        ...
        if (!props.category) {
            ...
            axios.post(`https://localhost:7062/api/Categories`, catToCreate).then(() => {
            ...
            axios.put(`https://localhost:7062/api/Categories/${props.category.categoryId}`, catToEdit).then(() => {
